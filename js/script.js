...
// Typewriter effect
function typeWriter(){
    let text="Hii Shoba Happy Valentine's Day❤️ I'm sorry I understand that ur going through something but as I told you whatever it is I'll be there for u knowingly or unknowingly whatever had happened just forget, things happen adhu la cross panni dhan varanu depression la poitu suma waste Shoba purinjiko okay vaa hope u understood we have lot more to see and achieve things together as I tell you from the day I saw you nee aasa pattadhu ellame you deserve. Idhuve podhu summa periya paragraph la oru mairu venda unnaku Byee Byee Happy valentine's again";
    let i=0;
    let speed=50;
    function typing(){
        if(i<text.length){
